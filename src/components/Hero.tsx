      ...
      <div className="container mx-auto px-6 md:px-12 z-10 text-center md:text-left flex flex-col md:flex-row items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <a 
              ...
              className="px-8 py-3 bg-transparent border-2 border-gray-700 text-white font-medium rounded-full hover:border-cyan-500 hover:text-cyan-400 transition-all flex items-center justify-center gap-2 w-full sm:w-auto"
            >
              <FiDownload /> Resume
            </a>
          </div>
        ...
        >
          ...
          <div className="relative w-72 h-72 md:w-96 md:h-96">
            ...
            {/* Floating Glassmorphic Center Circle with Image */}
            <motion.div
              animate={{ y: [-10, 10, -10] }}
              transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
              className="absolute inset-10 bg-black rounded-full border border-gray-700/40 shadow-[0_0_35px_rgba(34,211,238,0.25)] flex items-center justify-center overflow-hidden group"
            >
              <div className="w-full h-full rounded-full overflow-hidden relative bg-black">
                {/* Subtle gradient overlay to match website's neon cyber style */}
                <div className="absolute inset-0 bg-gradient-to-t from-gray-950/40 via-transparent to-cyan-500/10 z-10 pointer-events-none" />
                <img
                  src={praveenImage}
